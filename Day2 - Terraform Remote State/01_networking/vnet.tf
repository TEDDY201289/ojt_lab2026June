...
resource "azurerm_network_interface" "nic" {
  ...
  ip_configuration {
    ...
    subnet_id                     = data.terraform_remote_state.network.outputs.subnet_ids[var.vms["OPENVPN-SERVER"].subnet_key] # subnets ouput ကိုသုံးချင်ရင် subnet_id = data.terraform_remote_state.network.outputs.subnets[var.vms["OPENVPN-SERVER"].subnet_key].id
